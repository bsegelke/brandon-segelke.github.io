...
noises[noises.length] ='barkagain'
// 8. [ ] `console.log` the length of `noises`
console.log(noises.legnth)
...
// Because it will be a list of names, we dont need different keys and properties just a list of strings. Array is great for that.
...
function getRandom(animals){
  //math.random multiplys times the length of the array, then rounded DOWN to get a random index that could exist
  var randomIndex = Math.floor(Math.random()*animals.length)
  //return animals to that index
